...
if __name__ == "__main__":
    ...
    generate_iscs(case_name="ibm-truststore-mgr", case_versions=[
        "1.5.0", "1.5.1", "1.5.2", "1.5.3", "1.5.4", "1.6.0", "1.6.1", "1.6.2", "1.7.0", "1.7.1", "1.7.2", "1.7.3"
    ])
    ...
    # Data Dictionary
    # -------------------------------------------------------------------------
    generate_iscs(case_name="ibm-data-dictionary", case_versions=[ "1.1.21", "1.1.22" ])
    ...
    generate_iscs(case_name="ibm-mas", architectures=["amd64"], case_versions=[
        ...
        "8.10.31", "8.10.32", "8.10.33", "8.10.35"
    ])
    ...
    generate_iscs(case_name="ibm-mas", case_versions=["9.0.5", "9.0.6", "9.0.7", "9.0.8", "9.0.9", "9.0.10", "9.0.21"])
    generate_iscs(case_name="ibm-mas", case_versions=["9.1.0", "9.1.1", "9.1.2", "9.1.3", "9.1.4", "9.1.5", "9.1.6", "9.1.7", "9.1.8", "9.1.10"])
    ...
    generate_iscs(case_name="ibm-mas-manage", case_versions=[
        ...
        "8.6.31", "8.6.32", "8.6.33", "8.6.34", "8.6.36"
    ...
    generate_iscs(case_name="ibm-mas-manage", case_versions=[
        ...
        "8.7.21", "8.7.22", "8.7.23", "8.7.24", "8.7.25", "8.7.26", "8.7.27", "8.7.28", "8.7.30"
    ], exclude_group="ibmmasMaximoIT")
    generate_iscs(case_name="ibm-mas-manage", case_versions=[
    ...
    generate_iscs(case_name="ibm-mas-manage", case_versions=[
        "9.1.0", "9.1.1", "9.1.2", "9.1.3", "9.1.4", "9.1.5", "9.1.6", "9.1.7", "9.1.8", "9.1.11"
    ], exclude_group="ibmmasMaximoIT")
    ...
    generate_iscs(case_name="ibm-mas-visualinspection", case_versions=[
        "9.0.0", "9.0.1", "9.0.2", "9.0.3", "9.0.4", "9.0.5", "9.0.6", "9.0.7", "9.0.8", "9.0.9", "9.0.10",
        "9.0.11", "9.0.12", "9.0.13", "9.0.14", "9.0.15", "9.0.16", "9.0.17"
    ])
    generate_iscs(case_name="ibm-mas-visualinspection", case_versions=[
        "9.1.0", "9.1.1", "9.1.2", "9.1.3", "9.1.4", "9.1.5", "9.1.6", "9.1.7", "9.1.10"
    ])

    # Maximo Assist
    # -------------------------------------------------------------------------
    generate_iscs(case_name="ibm-mas-assist", architectures=["amd64"], case_versions=[
        "9.1.0", "9.1.1", "9.1.3", "9.1.4", "9.1.5", "9.1.6", "9.1.7", "9.1.8"
    ])
    generate_iscs(case_name="ibm-mas-assist", architectures=["amd64"], case_versions=[
        "9.0.0", "9.0.1", "9.0.2", "9.0.3", "9.0.4", "9.0.5", "9.0.6", "9.0.7", "9.0.8", "9.0.9", "9.0.10", "9.0.11", "9.0.12", "9.0.13", "9.0.14"
    ])
    generate_iscs(case_name="ibm-mas-assist", architectures=["amd64"], case_versions=[
    ...
    generate_iscs(case_name="ibm-mas-iot", architectures=["amd64"], case_versions=[
        "9.0.0", "9.0.1", "9.0.2", "9.0.3", "9.0.4", "9.0.5", "9.0.6", "9.0.7", "9.0.8", "9.0.9", "9.0.10", "9.0.11", "9.0.12", "9.0.13", "9.0.14", "9.0.15", "9.0.16", "9.0.17"
    ])
    generate_iscs(case_name="ibm-mas-iot", architectures=["amd64"], case_versions=[
        "8.8.0", "8.8.1", "8.8.2", "8.8.3", "8.8.4", "8.8.5", "8.8.6", "8.8.7", "8.8.8", "8.8.9", "8.8.10", "8.8.11", "8.8.12", "8.8.13", "8.8.14", "8.8.15", "8.8.16", "8.8.17", "8.8.18", "8.8.19", "8.8.20", "8.8.21", "8.8.22", "8.8.23", "8.8.24", "8.8.25", "8.8.26", "8.8.27", "8.8.28"
    ])
    generate_iscs(case_name="ibm-mas-iot", architectures=["amd64"], case_versions=[
        "8.7.0", "8.7.1", "8.7.2", "8.7.3", "8.7.4", "8.7.5", "8.7.6", "8.7.7", "8.7.8", "8.7.9", "8.7.10", "8.7.11", "8.7.13", "8.7.14", "8.7.15", "8.7.16", "8.7.17", "8.7.18", "8.7.19", "8.7.20", "8.7.21", "8.7.22", "8.7.23", "8.7.24", "8.7.25", "8.7.26", "8.7.27", "8.7.28", "8.7.26", "8.7.27", "8.7.28"
    ])
    ...
    generate_iscs(case_name="ibm-mas-monitor", architectures=["amd64"], case_versions=[
        "9.0.0", "9.0.1", "9.0.2", "9.0.3", "9.0.4", "9.0.5", "9.0.6", "9.0.7", "9.0.8", "9.0.9", "9.0.10", "9.0.11", "9.0.12", "9.0.13", "9.0.14", "9.0.15", "9.0.16", "9.0.17", "9.0.18"
    ])
    generate_iscs(case_name="ibm-mas-monitor", architectures=["amd64"], case_versions=[
        "8.11.0", "8.11.1", "8.11.2", "8.11.3", "8.11.4", "8.11.5", "8.11.6", "8.11.7", "8.11.8", "8.11.9", "8.11.10", "8.11.11", "8.11.12", "8.11.13", "8.11.14", "8.11.15", "8.11.16", "8.11.17", "8.11.18", "8.11.19", "8.11.20", "8.11.21", "8.11.22", "8.11.23", "8.11.24", "8.11.25", "8.11.26"
    ])
    generate_iscs(case_name="ibm-mas-monitor", architectures=["amd64"], case_versions=[
        "8.10.0", "8.10.1", "8.10.2", "8.10.3", "8.10.4", "8.10.5", "8.10.6", "8.10.7", "8.10.8", "8.10.9", "8.10.10", "8.10.11", "8.10.12", "8.10.13", "8.10.14", "8.10.15", "8.10.16", "8.10.17", "8.10.18", "8.10.19", "8.10.20", "8.10.21", "8.10.22", "8.10.23", "8.10.24", "8.10.25", "8.10.26", "8.10.27", "8.10.28"
    ])

    # Maximo Optimizer
    # -------------------------------------------------------------------------
    generate_iscs(case_name="ibm-mas-optimizer", architectures=["amd64"], case_versions=[
        "9.1.0", "9.1.2", "9.1.3", "9.1.4", "9.1.5", "9.1.6", "9.1.7", "9.1.8", "9.1.9"
    ])
    generate_iscs(case_name="ibm-mas-optimizer", architectures=["amd64"], case_versions=[
        "9.0.0", "9.0.1", "9.0.2", "9.0.3", "9.0.4", "9.0.5", "9.0.6", "9.0.7", "9.0.8", "9.0.9", "9.0.10", "9.0.12", "9.0.13", "9.0.14", "9.0.15", "9.0.16", "9.0.19", "9.0.20"
    ])
    generate_iscs(case_name="ibm-mas-optimizer", architectures=["amd64"], case_versions=[
        "8.5.0", "8.5.1", "8.5.2", "8.5.3", "8.5.4", "8.5.5", "8.5.6", "8.5.7", "8.5.8", "8.5.9", "8.5.10", "8.5.11", "8.5.12", "8.5.13", "8.5.14", "8.5.15", "8.5.16", "8.5.18", "8.5.19", "8.5.20", "8.5.21", "8.5.22", "8.5.24", "8.5.25", "8.5.26"
    ])
    generate_iscs(case_name="ibm-mas-optimizer", architectures=["amd64"], case_versions=[
        "8.4.0", "8.4.1", "8.4.2", "8.4.3", "8.4.4", "8.4.5", "8.4.6", "8.4.7", "8.4.8", "8.4.9", "8.4.10", "8.4.11", "8.4.12", "8.4.13", "8.4.14", "8.4.15", "8.4.16", "8.4.17", "8.4.19", "8.4.20", "8.4.21", "8.4.22", "8.4.23", "8.4.25", "8.4.26"
    ])
    ...
    generate_iscs(case_name="ibm-mas-predict", architectures=["amd64"], case_versions=[
        "9.0.0", "9.0.1", "9.0.2", "9.0.3", "9.0.4", "9.0.5", "9.0.6", "9.0.7", "9.0.8", "9.0.9", "9.0.10", "9.0.11", "9.0.12"
    ])
    generate_iscs(case_name="ibm-mas-predict", architectures=["amd64"], case_versions=[
        "8.9.0", "8.9.1", "8.9.2", "8.9.3", "8.9.4", "8.9.5", "8.9.6", "8.9.7", "8.9.8", "8.9.9", "8.9.10", "8.9.11", "8.9.12", "8.9.13", "8.9.14", "8.9.15"
    ])
    generate_iscs(case_name="ibm-mas-predict", architectures=["amd64"], case_versions=[
        "8.8.0", "8.8.1", "8.8.2", "8.8.3", "8.8.4", "8.8.5", "8.8.6", "8.8.7", "8.8.8", "8.8.9", "8.8.10", "8.8.11", "8.8.12", "8.8.13"
    ])
    ...
    generate_iscs(case_name="ibm-aiservice", case_versions=[
        "9.1.6", "9.1.7", "9.1.9", "9.1.10", "9.1.11", "9.1.12"
    ])
